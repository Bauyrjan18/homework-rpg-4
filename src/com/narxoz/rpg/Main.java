...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n--- Bridge Preview ---");
        System.out.println(slashFire.getSkillName() + " using " + slashFire.getEffectName() + " (Damage: " + slashFire.getBasePower() + ")");
        System.out.println(slashIce.getSkillName() + " using " + slashIce.getEffectName() + " (Damage: " + slashIce.getBasePower() + ")");
        System.out.println(stormFire.getSkillName() + " using " + stormFire.getEffectName() + " (Damage: " + stormFire.getBasePower() + ")");
